...
To learn more about Load Factor, see Edit One Existing Blockstore.
        ...
        object_lock_enabled: Optional[bool] = Field(None, serialization_alias="objectLockEnabled")
...
Expected response body
    ...
    class GetAllQueryParams(BaseModel):
        ...
        """Indicates whether to return only S3 blockstores to which you can assign new backup jobs.
        """
