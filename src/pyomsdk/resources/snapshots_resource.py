...
For endpoints that return a list of results, the content object is an envelope. Ops Manager adds the status field to the response body.
    ...
    def get_all_config_server(self,
    ...
    class GetAllClusterQueryParams(BaseModel):
        ...
        completed: Optional[SnapshotCompletedState] = Field(SnapshotCompletedState."TRUE", serialization_alias="completed")
...
Expected response body
    ...
    def get_one_config_server(self,
...
For endpoints that return a list of results, the results object is an envelope. Ops Manager adds the status field to the response body.
    ...
    def create_one_on_demand_cluster(self,
