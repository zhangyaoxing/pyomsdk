...
def _org_id(org: dict[str, Any]) -> Optional[str]:
...
def test_organizations_get_one_organization(client: OpsManagerClient, org: dict[str, Any]) -> None:
    ...
    org_id = _org_id(org)
    assert org_id is not None
    path_params = OrganizationsResource.GetOneOrganizationPathParams(org_id=org_id)
...
def test_organizations_get_all_projects(
    ...
    org_id = _org_id(org)
    assert org_id is not None
    path_params = OrganizationsResource.GetAllProjectsPathParams(org_id=org_id)
...
def test_organizations_get_all_users(client: OpsManagerClient, org: dict[str, Any]) -> None:
    ...
    org_id = _org_id(org)
    assert org_id is not None
    path_params = OrganizationsResource.GetAllUsersPathParams(org_id=org_id)
